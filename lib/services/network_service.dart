...
class NetworkService {
  ...
  ///for unsplash
  static const API_UN_USER_ME = "/me";
  static const API_UN_USER_PROFILE = "/users";
  static const API_UN_ALL_PHOTO = "/photos";
  static const API_UN_SEARCH_PHOTO = "/search/photos";
  static const API_UN_SEARCH_COLLECTIONS = "/search/collections";
  static const API_UN_SEARCH_USERS = "/search/users";
  static const API_UN_LIST_COLLECTIONS = "/collections";

  // headers
  static Map<String, String> headers = {
    'Content-Type': 'application/json',
    'x-api-key': '54d4b41e-06d1-4ac3-ac8f-8d25131e2653',
  };
  ...
  // static Map<String, String> headersForUnsplash = {
  //   'Authorization': 'Client-ID BnsLGjK1MQuhm8rZpL7w93HSibXcajzNgu_EQdWZTqQ',
  // };
  ...
  static Map<String, String> paramsSearchPhoto(String queryName) {
    Map<String, String> map = {
      'query': queryName
    };
    return map;
